# BNO055 Dual-Mode Logger

Complete firmware for the Adafruit Feather ESP32 V2 with BNO055 IMU sensor, supporting two operating modes based on power source.
